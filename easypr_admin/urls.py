...
urlpatterns  =  [
	...
	# url(r'^/admin/$',                         				views.dashboardView,      name='admin-dashboard'),
	url(r'^(?P<section_title>[-\w]+)/$',               views.dashboardView,                name='admin-dashboard'),
	
	url(r'^ajax/ajax-load-page/$',                    views.ajaxLoadDashboard,             name='load-content-page'),
	url(r'^ajax/fetch-single-post/$',                 views.fetchSinglePost,               name='fetch-post'),
	url(r'^ajax/save-changes/$',                      views.updatePost,                    name='update-post'),
	...
	url(r'^process/publish-post/$',                   views.publishPost,                   name='publish-post'),
