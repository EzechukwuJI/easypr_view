...
class ServiceRequestForm(forms.ModelForm):
	...
	# brief_description   =    forms.CharField(max_length = 450, required=False, widget=forms.Textarea(attrs={'class' : 'form-control no-border-radius bg-white border-thick','rows':5,'placeholder':"Briefly describe the service you want."}))
	# brief_description   =    forms.CharField(max_length = 450, required=False, widget=forms.Textarea(attrs={'class' : 'form-control no-border-radius bg-white border-thick','rows':5,'placeholder':"Briefly describe the service you want."}))
	...
	# 	self.fields['brief_description'].required = self.instance.pk is None
